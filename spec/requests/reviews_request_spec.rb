...
RSpec.describe "Reviews", type: :request do
  ...
  describe "POST #create" do
    ...
    context "パラメータが正常なとき" do
      ...
      subject { post(post_reviews_path(parapost.id), params: { review: { content: "初心者も入り安いと思う！", star: 4.5 ,post_id: parapost.id } }) }
    ...
    context "パラメータが異常なとき" do
      ...
      subject { post(post_reviews_path(parapost.id), params: { review: { content: nil, star: 4.5 ,post_id: parapost.id } }) }
